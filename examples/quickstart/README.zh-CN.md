...
环境要求：Go 1.26.6 或更高版本、Node.js 22.22.2+（22.x）、24.15.0+（24.x）或 26+、npm 和 curl。
...
`workflow.json` 的 `max_task_instances_per_node: 10` 表示每个定义节点各自最多产生 10 个 Task 实例，流程不再设置实例总数上限。
