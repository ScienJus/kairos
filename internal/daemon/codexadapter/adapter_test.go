...
func TestProbeVersionAndOptionsCompatibility(t *testing.T) {
	for _, tc := range []struct {
		...
		{"codex-cli 0.153.4-beta", "success", ""},
		{"codex-cli 0.154.0-alpha.6.2", "success", ""},
		{"codex-cli 0.154.0-alpha.6.2+build.1", "success", ""},
		{"codex-cli 0.146.0+build.1", "success", ""},
		{"codex-cli 0.146.0-alpha.1", "success", "Codex CLI 0.146.0 or newer is required"},
		{"codex-cli 0.146.1-alpha.1", "success", ""},
		{"codex-cli 0.154.0-alpha..1", "success", "Codex CLI 0.146.0 or newer is required"},
		{"codex-cli 0.154.0-alpha.6.2", "unsupported_options", "Codex CLI does not support the required execution options"},
