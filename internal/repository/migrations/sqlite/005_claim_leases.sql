ALTER TABLE claims ADD COLUMN last_heartbeat_at_ns INTEGER;
-- +kairos StatementBreak
ALTER TABLE claims ADD COLUMN lease_until_ns INTEGER;
-- +kairos StatementBreak
...
WHERE active = 1 AND lease_until_ns IS NULL AND executor_kind = 'agent';
