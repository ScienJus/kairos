...
type ReadStore interface {
	...
	FindWaitingWorkflowTaskActivation(domain.WorkItemID, domain.WorkflowTaskID, domain.WorkflowCorrelationID) (domain.WorkflowTaskActivation, bool, error)
	CountResolvedWorkflowTaskActivations(domain.WorkItemID, domain.WorkflowTaskID) (int, error)
	NextTaskPosition(domain.WorkItemID) (int64, error)
