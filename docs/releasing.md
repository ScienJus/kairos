...
- Enable GitHub Pages with the `Deploy documentation` workflow. The expected homepage is `https://www.scienjus.com/kairos/`.
...
- Homepage: `https://www.scienjus.com/kairos/` after the Pages workflow has completed successfully.
