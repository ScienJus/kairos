...
const messages = {
  en: {
    ...
    noDescription: 'No execution description.', executor: 'Executor', role: 'Role', claim: 'Claim', claimedBy: 'Claimed by', executedBy: 'Executed by', unclaimed: 'Unclaimed', unrestricted: 'Unrestricted', acceptance: 'Acceptance', latestResult: 'Latest result',
    ...
    statusOpen: 'Open', statusCompleted: 'Complete', statusCancelled: 'Cancelled', statusFailed: 'Failed', statusPending: 'Pending', statusWorking: 'Active', statusWaiting: 'Waiting on subtasks', statusReview: 'Review', statusSkipped: 'Skipped', statusNotReached: 'Not reached',
  ...
  'zh-CN': {
    ...
    noDescription: '暂无执行说明。', executor: '执行者', role: '角色', claim: 'Claim', claimedBy: '认领人', executedBy: '执行人', unclaimed: '尚未认领', unrestricted: '无限制', acceptance: '验收标准', latestResult: '最新结果',
    ...
    statusOpen: '进行中', statusCompleted: '已完成', statusCancelled: '已取消', statusFailed: '已失败', statusPending: '待处理', statusWorking: '执行中', statusWaiting: '等待子任务', statusReview: '待 Review', statusSkipped: '已跳过', statusNotReached: '尚未到达',
