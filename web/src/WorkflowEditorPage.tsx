...
function validationMessage(error: string) {
  const messages = {
    ...
    'execution-limit': 'validationExecutionLimit', 'duplicate-relation': 'validationDuplicateRelation',
  } as const
