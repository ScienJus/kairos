...
export function Modal({ open, onOpenChange, title, eyebrow, children, className = '' }: {
  open: boolean; onOpenChange: (open: boolean) => void; title: string; eyebrow: string; children: ReactNode; className?: string
}) {
  const { t } = useI18n()
